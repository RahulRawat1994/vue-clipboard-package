...
interface ClipboardHTMLElement extends HTMLElement {
  _vClipboardHandler?: (this: ClipboardHTMLElement, ev: Event) => void // Define the handler type
}

const vClipboard = {
  mounted(el: ClipboardHTMLElement, binding: any) {
  ...
  beforeUnmount(el: ClipboardHTMLElement) {
